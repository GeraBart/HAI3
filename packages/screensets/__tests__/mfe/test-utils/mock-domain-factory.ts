...
export class MockDomainFactory extends ExtensionDomainImplementationFactory {
   ...
   */
  private _registry: ScreensetsRegistry | null = null;
   ...
   */
  setRegistry(registry: ScreensetsRegistry): this {
  ...
  build(ctx: DomainContext): ExtensionDomainImplementation {
    ...
    if (this._permissive) {
      ...
      const alreadyHandled = new Set([
        HAI3_ACTION_LOAD_EXT,   // pre-populated by DefaultScreensetsRegistry
