 ...
 * `cpt-frontx-algo-screenset-registry-cross-validate-handlers` is enforced by
 ...
 */
// @cpt-FEATURE:cpt-frontx-feature-screenset-registry:p2
 ...
 * (`cpt-frontx-algo-screenset-registry-cross-validate-handlers`) enforces the
