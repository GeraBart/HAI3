 ...
 */
// Registry contract (DoD has unchecked tasks; begin/end blocks in DefaultScreensetsRegistry carry traceability)
...
export abstract class ScreensetsRegistry {
   ...
   * `cpt-frontx-dod-screenset-registry-mount-contracts`.
   *
   * @param domainId - ID of the domain
