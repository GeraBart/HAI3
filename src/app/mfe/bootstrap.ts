...
class ScreenDomainImpl extends ExtensionDomainImplementation {
  ...
  constructor(ctx: DomainContext, hooks: ContainerHooks, registry: ScreensetsRegistry, domainId: string) {
    super();
...
class ScreenDomainFactory extends ExtensionDomainImplementationFactory {
  constructor(private readonly registry: ScreensetsRegistry) { super(); }
 ...
 * `cpt-frontx-dod-screenset-registry-mfe-schema-registration` (parent
 ...
 */
function hostOwnsDomain(registry: ScreensetsRegistry, domainId: string): boolean {
