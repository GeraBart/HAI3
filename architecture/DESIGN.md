...
| `cpt-frontx-interface-screensets` | `@cyberfabric/screensets` | MFE type system, ScreensetsRegistry, MfeHandler, MfeBridge, ExtensionDomainImplementation / DomainContext / ExtensionMounter / ContainerHooks, ConcurrentMountStrategy / OptionalMountStrategy / ExclusiveMountStrategy, GTS validation plugin, action/property constants |
